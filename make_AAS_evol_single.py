...
### Dens Ref ###
densR = yt.ProjectionPlot(dsREF,'x','H_nuclei_density',data_source=rbR,center=rb_centerR,width=(rb_widthR,'code_length'))
...
cbaxes = fig.add_axes([0.032, -0.015, 0.286, 0.02])
...
cbaxes2 = fig.add_axes([0.358, -0.015, 0.286, 0.02])
...
cbaxes3 = fig.add_axes([0.683, -0.015, 0.286, 0.02])
